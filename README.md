...
git fetch upstream
git switch -c aptos-release-v1.5-pt01 upstream/aptos-release-v1.5
git push --set-upstream origin aptos-release-v1.5-pt01
.... coding ....
git commit
.... .... .... ....
git push
#
#
git clone -b aptos-release-v1.5-pt01 --single-branch https://github.com/hexiaoyuan/aptos-core.git src
cd src
